    ...
    <>
      ...
      <div className="text-base-white flex h-full w-full flex-col">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="mb-24 w-full space-y-10 rounded-3xl border-4 border-brown-500 bg-brown-400 px-20 py-14 shadow-lg">
              ...
              <div className="flex items-start justify-between gap-2">
                <p className="text-justify text-2xl">
                  ...
                  Maranhão-UEMA, licenciado em História pela Universidade
                  Estadual do Piauí-UESPI. Mestre na área de Ensino de História
                  pela Universidade Federal do Tocantins-UFT-Campus Araguaína.
                  Docente Efetivo com Dedicação Exclusiva do Instituto Federal
                  de Educação, Ciência e Tecnologia do Maranhão-Campus São João
                  dos Patos. Pesquisa na(s) área(s): Ensino de História,
            ...
            <div className="mb-24 w-full space-y-10 rounded-3xl border-4 border-brown-500 bg-brown-400 px-20 py-14 shadow-lg">
              ...
              <div className="flex items-start justify-between gap-2">
                <p className="text-justify text-2xl">
                  Doutor em História pela Universidade Federal Fluminense (2010)
                  e pós-doutor pela Universidade Nova de Lisboa (2020).
                  Professor, desde 2002, do Departamento de História da
                  Universidade Estadual do Maranhão e, desde 2014, do Programa
                  de Pós-graduação em História - mestrado e doutorado (PPGHIST).
                  Atua nas áreas de História do Brasil e do Maranhão, no
                  Oitocentos. Orienta pesquisas sobre história política, com
                  ênfase na circulação de ideias e de impressos. É o atual
                  Pró-reitor de Pesquisa e Pós-graduação da Universidade
                  Estadual do Maranhão (2023-2026).
                </p>
        ...
        <div className="bg-brown-800 px-44 py-24">
          <h2 className="mb-5 text-6xl font-light">
            Entre em contato conosto!
          </h2>
          ...
          >
            ...
            <button
              type="submit"
              className="rounded-full bg-brown-300 px-28 py-5 text-center text-3xl font-semibold italic text-brown-800 shadow-2xl"
            >
              enviar
            </button>
          </form>
